...
publicly described GravityX approach for GO Competition Challenge 2.  Its
optimization models are constructed with the actual open-source
[Gravity C++](https://github.com/coin-or/Gravity) modeling framework and solved
with open-source Ipopt.
...
- Target case: GO Challenge 2 Final `C2FEN00617`, scenario `005`.
